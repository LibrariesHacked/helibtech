...
Maturity level assessments are structured diagnostic tools used to evaluate an organization's current capabilities. As part of Higher Education Library Technology  Ken Chad Consulting has developed a draft AI 'maturity model' for UK HE and FE libraries. It is informed by work with libraries, published literature and the work by Jisc on institutional maturity models to support their Digital Transformation work. It measures library capability, not simply by the number of AI tools deployed. Many libraries are experimenting with AI, but maturity depends on governance, workforce capability, integration with services, and alignment with library and institutional strategy and importantly changing student expectations
